"""Frozen compatibility repair for pre-Bundle legacy run directories.

Portrait Bundle input must never import or call this module. New repair policy
belongs exclusively to the upstream producer; this copy exists only so old
flat runs can cross the new input seam once.
"""
